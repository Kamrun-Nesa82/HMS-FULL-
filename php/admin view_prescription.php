    ...
    <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        ...
        <li class="nav-item"><a class="nav-link active" href="../html/admin dashboard.html"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="../php/doctor_dash.php"><i class="fas fa-user-md"></i> <span>Manage Doctors</span></a></li>
            <li class="nav-item"><a class="nav-link" href="../php/admin view_appointment.php"><i class="fas fa-calendar-alt"></i> <span>Appointments</span></a></li>
            <li class="nav-item"><a class="nav-link" href="../php/admin view_prescription.php"><i class="fas fa-prescription-bottle-alt"></i> <span>Prescriptions</span></a></li>
            <li class="nav-item"><a class="nav-link" href="../php/contact_dash.php"><i class="fas fa-question-circle"></i> <span>Queries</span></a></li>
        </ul>
      </div>
    </nav>
