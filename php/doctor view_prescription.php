  ...
  <div class="row">
    ...
    <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        ...
        <li class="nav-item">
              <a class="nav-link active" href="../html/doctor dashboard.html">
                <i class="fas fa-tachometer-alt"></i> <span>Dashboard</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../php/view appointment_doctor.php">
                <i class="fas fa-calendar-check"></i> <span>Appointments</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../php/doctor view_prescription">
            ...
            if ($result) {
              while ($row = mysqli_fetch_assoc($result)) {
                echo '<tr>
                  ...
                  <td>
                    <button class="btn btn-primary"><a href="update prescription.php?updateid=' . $row['pr_id'] . '" class="text-light">Update</a></button>
                  </td>
                </tr>';
              }
            }
